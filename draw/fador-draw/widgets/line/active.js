...
var LINE_ACTIVE_STYLE = {
  borderWidth: 1,
  borderColor: "#000",
  dashed: true
};
var LineActiveLayer = /*#__PURE__*/function () {
  function LineActiveLayer(config) {
    _classCallCheck(this, LineActiveLayer);
    _defineProperty(this, "style", void 0);
    _defineProperty(this, "start", void 0);
    _defineProperty(this, "end", void 0);
    this.style = styleMerge(LINE_ACTIVE_STYLE, config);
  }
  _createClass(LineActiveLayer, [{
    key: "setActived",
    value: function setActived(x, y) {
      var p = new Point(x, y);
